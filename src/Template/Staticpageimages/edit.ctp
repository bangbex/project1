...
?>
    ...
    <div class='row'>
    <div class='col-md-6'>
    <?= $this->Form->create($staticpageimages , ['role'=>'form']) ?>
        <?php
            echo $this->Form->control('staticpage_id', ['options' => $staticpage ,'style'=>'width:100%', 'class'=>'form-control select2']);
            echo $this->Form->control('filename', ['class'=>'form-control']);
            echo $this->Form->control('relative_path', ['class'=>'form-control']);
            echo $this->Form->control('dir', ['class'=>'form-control']);
