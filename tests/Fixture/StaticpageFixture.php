 ...
 *
 */
class StaticpageFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'kategoriartikel_id' => ['type' => 'index', 'columns' => ['menu_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'is_published' => 1,
            'created' => '2018-03-09 02:06:42',
            'modified' => '2018-03-09 02:06:42'
        ],
    ];
}
