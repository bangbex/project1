...
class ArtikelFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'kategoriartikel_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'kategoriartikel_id' => ['type' => 'index', 'columns' => ['kategoriartikel_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'is_published' => 1,
            'created' => '2018-03-09 02:06:49',
            'modified' => '2018-03-09 02:06:49'
        ],
    ];
}
